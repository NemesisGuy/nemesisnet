...
const PAGES_TO_AUDIT = [
  ...
  { url: 'https://nemesisnet.co.za/contact', name: 'Contact' },
  { url: 'https://nemesisnet.co.za/projects/torquebooks', name: 'Project: TorqueBooks' },
  ...
  { url: 'https://nemesisnet.co.za/projects/pockettts-mcp', name: 'Project: PocketTTS MCP' },
  ...
  { url: 'https://nemesisnet.co.za/services/ai-development', name: 'Service: AI Dev' },
  ...
  { url: 'https://nemesisnet.co.za/services/self-hosted-ai', name: 'Service: Self-Hosted AI' },
  { url: 'https://nemesisnet.co.za/services/static-sites', name: 'Service: Static & Brochure' },
  { url: 'https://nemesisnet.co.za/services/app-starter', name: 'Service: App Starter' },
  { url: 'https://nemesisnet.co.za/services/business-systems', name: 'Service: Business Systems' },
  { url: 'https://nemesisnet.co.za/services/platform-enterprise', name: 'Service: Platform / Enterprise' },
  { url: 'https://nemesisnet.co.za/services/agile-iterative', name: 'Service: Agile & Iterative' },
  { url: 'https://nemesisnet.co.za/services/waterfall-structured', name: 'Service: Waterfall & Structured' },
  { url: 'https://nemesisnet.co.za/services/ai-consulting', name: 'Service: AI Consulting' },
  { url: 'https://nemesisnet.co.za/services/mcp-integrations', name: 'Service: MCP Integrations' },
  { url: 'https://nemesisnet.co.za/services/light-hosting', name: 'Service: Light Hosting' },
  { url: 'https://nemesisnet.co.za/services/managed-retainer', name: 'Service: Managed Retainer' },
...
async function auditPage(pageUrl, pageName, retries = 2) {
