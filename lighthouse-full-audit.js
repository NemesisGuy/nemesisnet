...
const PAGES_TO_AUDIT = [
  { url: 'https://dev.nemesisnet.co.za/', name: 'Homepage' },
  { url: 'https://dev.nemesisnet.co.za/projects', name: 'Projects' },
  { url: 'https://dev.nemesisnet.co.za/services', name: 'Services' },
  { url: 'https://dev.nemesisnet.co.za/about', name: 'About' },
  { url: 'https://dev.nemesisnet.co.za/projects/kokoro-tts', name: 'Project: Kokoro TTS' },
  { url: 'https://dev.nemesisnet.co.za/projects/wordpress-mcp', name: 'Project: WordPress MCP' },
  { url: 'https://dev.nemesisnet.co.za/projects/nk-assessments', name: 'Project: NK Assessments' },
  { url: 'https://dev.nemesisnet.co.za/projects/codecritical-cli', name: 'Project: CodeCritical CLI' },
  { url: 'https://dev.nemesisnet.co.za/projects/codecritical-saas', name: 'Project: CodeCritical SaaS' },
  { url: 'https://dev.nemesisnet.co.za/projects/vibetype', name: 'Project: VibeType' },
  { url: 'https://dev.nemesisnet.co.za/projects/forkmyfolio', name: 'Project: ForkMyFolio' },
  { url: 'https://dev.nemesisnet.co.za/projects/onthegorentals', name: 'Project: OnTheGoRentals' },
  { url: 'https://dev.nemesisnet.co.za/projects/bored-room-cafe', name: 'Project: Bored Room Cafe' },
  { url: 'https://dev.nemesisnet.co.za/projects/voxnemesis-supertonic', name: 'Project: VoxNemesis' },
  { url: 'https://dev.nemesisnet.co.za/projects/since', name: 'Project: Since' },
  { url: 'https://dev.nemesisnet.co.za/services/custom-software', name: 'Service: Custom Software' },
  { url: 'https://dev.nemesisnet.co.za/services/saas-development', name: 'Service: SaaS Dev' },
  { url: 'https://dev.nemesisnet.co.za/services/infrastructure', name: 'Service: Infrastructure' },
  { url: 'https://dev.nemesisnet.co.za/services/consulting', name: 'Service: Consulting' },
  { url: 'https://dev.nemesisnet.co.za/legal/terms', name: 'Legal: Terms' },
  { url: 'https://dev.nemesisnet.co.za/legal/privacy', name: 'Legal: Privacy' },
  { url: 'https://dev.nemesisnet.co.za/legal/refund', name: 'Legal: Refund' }
];
