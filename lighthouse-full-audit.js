...
const PAGES_TO_AUDIT = [
  ...
  { url: 'https://dev.nemesisnet.co.za/projects/codecritical', name: 'Project: CodeCritical CLI' },
  ...
  { url: 'https://dev.nemesisnet.co.za/services/saas-dev', name: 'Service: SaaS Dev' },
