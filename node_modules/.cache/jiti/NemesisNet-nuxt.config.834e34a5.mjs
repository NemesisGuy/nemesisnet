"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _prerenderRoutes = await jitiImport("./config/prerender-routes");var _default = exports.default =
...
defineNuxtConfig({
  ...
  nitro: {
    ...
    prerender: {
      crawlLinks: true,
      routes: _prerenderRoutes.PRERENDER_ROUTES,
      failOnError: false
    }
  },
  app: {
