import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, h, inject, computed, unref, shallowRef, provide, shallowReactive, createElementBlock, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/unctx/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/vue/server-renderer/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/Reign/Projects/NemesisNet/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    name: "legal-privacy",
    path: "/legal/privacy",
    component: () => import('./privacy-BOHT93Hd.mjs')
  },
  {
    name: "legal-refund",
    path: "/legal/refund",
    component: () => import('./refund-DXcdnfyM.mjs')
  },
  {
    name: "legal-terms",
    path: "/legal/terms",
    component: () => import('./terms-fbjCHc4Q.mjs')
  },
  {
    name: "projects-bored-room-cafe",
    path: "/projects/bored-room-cafe",
    component: () => import('./bored-room-cafe-DFHPNS1i.mjs')
  },
  {
    name: "projects-codecritical",
    path: "/projects/codecritical",
    component: () => import('./codecritical-V5MV89ME.mjs')
  },
  {
    name: "projects-codecritical-saas",
    path: "/projects/codecritical-saas",
    component: () => import('./codecritical-saas-B0krfej7.mjs')
  },
  {
    name: "projects-forkmyfolio",
    path: "/projects/forkmyfolio",
    component: () => import('./forkmyfolio-buUAy_xM.mjs')
  },
  {
    name: "projects-kokoro-tts",
    path: "/projects/kokoro-tts",
    component: () => import('./kokoro-tts-BKhEBcDf.mjs')
  },
  {
    name: "projects-nk-assessments",
    path: "/projects/nk-assessments",
    component: () => import('./nk-assessments-Ch7anjPa.mjs')
  },
  {
    name: "projects-onthegorentals",
    path: "/projects/onthegorentals",
    component: () => import('./onthegorentals-BK_NxHvZ.mjs')
  },
  {
    name: "projects-since",
    path: "/projects/since",
    component: () => import('./since-DZB3tu8c.mjs')
  },
  {
    name: "projects-vibetype",
    path: "/projects/vibetype",
    component: () => import('./vibetype-Cl-tQ4mY.mjs')
  },
  {
    name: "projects-voxnemesis-supertonic",
    path: "/projects/voxnemesis-supertonic",
    component: () => import('./voxnemesis-supertonic-CH_25_rc.mjs')
  },
  {
    name: "projects-wordpress-mcp",
    path: "/projects/wordpress-mcp",
    component: () => import('./wordpress-mcp-P3tuaIzU.mjs')
  },
  {
    name: "services-consulting",
    path: "/services/consulting",
    component: () => import('./consulting-BNgbUmvA.mjs')
  },
  {
    name: "services-custom-software",
    path: "/services/custom-software",
    component: () => import('./custom-software-BRHKi5qG.mjs')
  },
  {
    name: "services-infrastructure",
    path: "/services/infrastructure",
    component: () => import('./infrastructure-B2USv-Tk.mjs')
  },
  {
    name: "services-saas-dev",
    path: "/services/saas-dev",
    component: () => import('./saas-dev-BDDTYB3t.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CHy21OwD.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-B2b7eRfZ.mjs')
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./index-DgCzhJa6.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Ct92p5v6.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CWCwRQyd.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DCiZGkvc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DcGTVT3n.mjs'));
