...
| WordPress MCP card | `https://github.com/NemesisGuy/WordPress-MCP` (placeholder Nemesis logo until screenshot captured) | `src/assets/images/projects/wordpress-mcp/original/hero.png` | `src/assets/images/projects/wordpress-mcp/optimized/hero.webp` | placeholder asset in place — replace with real screenshot soon |
