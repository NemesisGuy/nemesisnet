    ...
    <div class="detail-container">
      <div class="detail-main">
        ...
        <ul class="feature-list feature-list--muted">
          <li><XCircle :size="18" /> Major application bug fixes</li>
          <li><XCircle :size="18" /> Feature development</li>
        ...
        <div class="retainer-disclaimer">
          <p><strong>Reserved support capacity.</strong> This retainer reserves the stated support and maintenance capacity for each billing period. Unused capacity does not accumulate or roll over into subsequent periods. Additional work beyond the included capacity is billed separately.</p>
