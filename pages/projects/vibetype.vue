<template>
  <div class="detail-page">
    <PageHeader title="Vibe-Type" subtitle="Experimental AI-powered coding and typing assistant." />

    <div class="detail-container">
      <div class="detail-main">
        <img
          src="/images/projects/vibetype/optimized/hero.webp" fetchpriority="high"
      ...
      <div class="detail-sidebar">
        <div class="sidebar-card">
          ...
          <ul class="sidebar-list">
            <li><span>Timeline:</span> <strong>Ongoing</strong></li>
            <li><span>Stack:</span> <strong>Python, OpenAI API, Local LLMs</strong></li>
            <li><span>Role:</span> <strong>R&D Lead</strong></li>
            <li><span>Status:</span> <strong>Experimental</strong></li>
          </ul>
        </div>
        <div class="sidebar-card">
          <h4>Quick Links</h4>
          <div class="quick-links">
            ...
            <a href="https://github.com/NemesisGuy/Vibe-Type" target="_blank" rel="noopener noreferrer" class="btn-glass" aria-label="View Source (opens in new tab)">View Source</a>
            <a href="https://blog.nemesisnet.co.za/vibetype-building-a-local-first-voice-coding-companion/" target="_blank" rel="noopener noreferrer" class="btn-glass" aria-label="Deep Dive (opens in new tab)">Deep Dive</a>
          </div>
        </div>
      </div>
    </div>
