      ...
      <div class="detail-sidebar">
        ...
        <div class="sidebar-card">
          ...
          <div class="quick-links">
            ...
            <a href="https://github.com/NemesisGuy/Kokoro_TTS_Service" target="_blank" rel="noopener noreferrer" class="btn-glass" aria-label="View Source (opens in new tab)">View Source</a>
            <a href="https://kokoro-gui.nemesisnet.co.za" target="_blank" rel="noopener noreferrer" class="btn-glass" aria-label="Live Demo (opens in new tab)">Live Demo</a>
          </div>
        </div>
      </div>
    </div>
...
<script setup>
useHead({
  title: 'Kokoro TTS Service | Self-Hosted Text-To-Speech | NemesisNet',
  meta: [
    ...
    { name: 'twitter:title', content: 'Kokoro TTS | Self-Hosted Neural Text-to-Speech | NemesisNet' },
    { name: 'twitter:description', content: 'Low-latency, self-hosted, private and open-source neural text-to-speech web service and REST API built on the Kokoro model.' }
  ],
  link: [
