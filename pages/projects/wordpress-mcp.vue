<template>
  <div class="detail-page">
    <PageHeader title="WordPress MCP Server" subtitle="Empowering AI agents with secure, local-first WordPress management." />

    <div class="detail-container">
      <div class="detail-main">
        <img
          src="/images/projects/wordpress-mcp/optimized/hero.webp" fetchpriority="high"
          srcset="/images/projects/wordpress-mcp/optimized/hero-480.webp 480w, /images/projects/wordpress-mcp/optimized/hero-640.webp 640w, /images/projects/wordpress-mcp/optimized/hero.webp 800w"
      ...
      <div class="detail-sidebar">
        <div class="sidebar-card">
          ...
          <ul class="sidebar-list">
            ...
            <li><span>Status:</span> <strong>Deployed</strong></li>
          </ul>
        </div>
        <div class="sidebar-card">
          <h4>Quick Links</h4>
          <div class="quick-links">
            ...
            <a href="https://github.com/NemesisGuy/WordPress-MCP" target="_blank" rel="noopener noreferrer" class="btn-glass" aria-label="View Source (opens in new tab)">View Source</a>
              <a href="https://blog.nemesisnet.co.za/bring-wordpress-into-your-agent-workflows-with-the-wordpress-mcp-server/" target="_blank" rel="noopener noreferrer" class="btn-glass" aria-label="Deep Dive (opens in new tab)">Deep Dive</a>
          </div>
        </div>
      </div>
    </div>
